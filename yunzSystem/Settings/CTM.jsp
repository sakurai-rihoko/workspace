      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-user"></i>债权人管理</a></li>
            <li><a href="index2.html"><i class="fa fa-user"></i>债务人管理</a></li>
          </ul>
        </li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-edit"></i>模板管理</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="box" id="tableBox">
              ...
              <div class="box-header">
                <div class="col-sm-10">
                  <h3 class="box-title">合同模板列表</h3>
                </div>
                <div class="col-sm-2">
                <button type="button" class="btn btn-block btn-primary btn-sm" id = "addNewTemplate">新建模板</button>
              </div>
              </div>
              
              <div class="box-body">
                <table id="Template" class="table table-bordered table-hover table-condensed table-striped">
                <thead>
                  <tr>
                    <th>模板名称</th>
                    <th>模板类型</th>
          ...
          <!--新增模板界面-->
            ...
            <div class="box" id = "addBox" style="display: none;">
              <div class="box-header">
                <div class="col-sm-10">
                  <h3 class="box-title">新建合同模板</h3>
                </div>
                <div class="col-sm-2">
                <button type="button" class="btn btn-block btn-primary btn-sm" id = "returnTemplateTable">返回</button>
              </div>
              </div>
