...
<div class="wrapper">
     ...
     <!-- <div class="user-panel">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../customer/list.jsp"><i class="fa fa-user"></i>债权人管理</a></li>
            <li><a href="../customer/debtor.jsp"><i class="fa fa-user"></i>债务人管理</a></li>
          </ul>
        </li>

        <li class="treeview active">
          <a href="contractManage.jsp"><i class="fa fa-files-o"></i><span>合同管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="<%=liClass %>"><a href="contractManage.jsp"><i class="fa fa-folder"></i>合同管理</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="box" name="ContractTableView">
          <div class="box-header">
            <div class="col-sm-10">
              <h3 class="box-title">合同列表</h3>
              </div>
              <div class="col-sm-2">
              <button type="button" class="btn btn-block btn-primary btn-sm" name = "addNewContract">新增</button>
              </div>
            </div>
            <div class="box-body">
        ...
        <div class="box" name="addContractView" style = "display: none;">
          <div class="box-header with-border">
          	...
          	<div class="col-sm-2">
          		<button type="button" class="btn btn-block btn-primary btn-sm" name = "returnToContractTable">返回</button>
          	</div>
          </div>
