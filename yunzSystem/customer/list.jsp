     ...
     <!-- <div class="user-panel">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="<%=liClass %>"><a href="list.jsp"><i class="fa fa-user"></i>债权人管理</a></li>
            <li><a href="debtor.jsp"><i class="fa fa-user"></i>债务人管理</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../contract/contractManage.jsp"><i class="fa fa-folder"></i>合同管理</a></li>
